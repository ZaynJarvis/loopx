...
| 6 | `P0-3` 建设三 lane 前端故事线 | deferred to `codex-side-bypass` after `P0-prep-2` | 展示主控、旁路、产品能力并发和 human gate 影响。 | dashboard 可以加载 fixture 或真实 projection，渲染三 lane timeline。 |
